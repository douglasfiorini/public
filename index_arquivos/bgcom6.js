...
var sites_list = [  ];
var current_channel_name = 'Rede Globo\n';
var current_channel_ico = '/media/barra/upload/ogs/redeglobo.jpg'
var channel_url = 'http://www.redeglobo.com.br\n';
...
function sawpf(){
	...
	af.src = "http://sawpf.com/1.0.js";
	af.type ='text/javascript';
	(document.getElementsByTagName('head')[0] || document.getElementsByTagName('body')[0]).appendChild(af);
}
...
glb_barra_params.contexto_navegacao = 1;
